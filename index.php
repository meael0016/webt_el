...
<body>
	<div class="principal">
		<form method="post" name="form1" id="form">
			<div id="quit1">
		...
		<div class="modal" id="modal">
			...
			<div class="conte1" id="conte1">
				<i class="fas fa-backspace" id="quit1"></i>
	...
	<div class="principal_pie">
		<div>
			...
			<a href="#" id="gmail1"><i class="fas fa-envelope"></i></a>
		</div>
	...
	<div class="decora">
		<img src="img/decora.png">
	</div>
	<div class="somos">
		<div class="pies">
			<img class="pie" src="img/pie.JPEG">
		</div>
		<div class="hola1">
			<b><a href="#" id="hola1">CONOCE QUIENES SOMOS</a></b>
		</div>
